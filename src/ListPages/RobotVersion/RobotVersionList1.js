...
const RobotVersionList1 = () => {
  ...
  // Function to handle email click and navigate to the app details page
  const handleEmailClick = (email) => {
    navigate(`/appdetails/${encodeEmail(email)}`); 
  };
    ...
    <Box sx={{ padding: 3, backgroundColor: "#f5f5f5", minHeight: '100vh' }}>
      <Paper elevation={3} sx={{ padding: 4, borderRadius: 2, backgroundColor: "#fff", boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
        <Typography variant="h4" component="h1" sx={{ marginBottom: 3, fontWeight: "bold", color: "#333" }}>
          List of Emails to Check the Metadata details
        </Typography>
...
export default RobotVersionList1;
